var path = require('path'),
    ...
    map = webpackPostcssTools.makeVarMap(path.join(__dirname, 'src/assets/styles/variables.css')),
    media = webpackPostcssTools.makeVarMap(path.join(__dirname, 'src/assets/styles/boot/responsive.css')),
